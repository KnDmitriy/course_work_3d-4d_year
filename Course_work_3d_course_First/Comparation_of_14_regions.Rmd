...
```{r}
dir_path <- "/Users/DmitryKonorov/Desktop/Основная_учеба/3й_курс/Курсовая_3й_курс/Данные из сообществ VK 2024/ПФО/14 регионов, 2023 год"
...
corp_city_dfs <- all_input_data
```
```{r}
# corp_city_dfs <- VCorpus(VectorSource(all_input_data))
for (i in seq_along(corp_city_dfs)) {
    corp_city_dfs[[i]] <- VCorpus(VectorSource(corp_city_dfs[[i]]))
}
```
...
```{r}
View(cos.mat)
write.xlsx(cos.mat, "//Users//DmitryKonorov//Desktop//Основная_учеба//3й_курс//Курсовая_3й_курс//Результаты 2023//Nizhegorodskaya_Oblast.xlsx", sheetName = "Sheet4", append=TRUE)
```
