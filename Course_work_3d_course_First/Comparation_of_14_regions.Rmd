...
packages <- c("ggplot2",  "data.table", "wordcloud", "tm", "wordcloud2", "tidytext", "devtools", "dplyr", 'tidyverse', 'readxl', 'udpipe', 'writexl', 'xlsx', 'rlang', 'plyr', 'lsa')
...
```{r}
all_regions_tf_idf_df <- join_all(freq_ratio_dfs, by = 'word', type = 'left')
```
```{r}
...
View(cos.mat)
write.xlsx(cos.mat, 
paste0(dir_path, '/Сравнение с помощью косинусной меры близости.xlsx', sep = ""), sheetName = "Sheet1", append=TRUE)
```
